<script>
    ...
    const ModalMobileMobile = () => {
        ...
        document.getElementById('logoutMobile-btn').addEventListener('click', function(e) {
    ...
    const initModalMobile = () => {
        ModalMobile();
    }
    document.addEventListener('DOMContentLoaded', initModalMobile());
