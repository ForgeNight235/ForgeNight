    ...
    <tr>
        <td align="center" style="background-color: #eeeeee;" bgcolor="#eeeeee">
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                <tr>
                    <td align="center" valign="top" style="font-size:0; padding: 35px;" bgcolor="#232323">
                        <!--[if (gte mso 9)|(IE)]>
                        <table align="center" border="0" cellspacing="0" cellpadding="0" width="600">
                            <tr>
                            ...
                            <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%"
                                ...
                                <tr>
                                    <td align="left" valign="top"
                                        ...
                                        class="mobile-center">
                                        <h1 style="font-size: 36px; font-weight: 800; margin: 0; color: #f2f2f2;">
                                            ForgeNight</h1>
                                    </td>
                                </tr>
                            </table>
...
{{--                                                            &nbsp;--}}
                ...
                <tr>
                    <td align="center" style="padding: 35px 35px 20px 35px; background-color: #f2f2f2;"
                        bgcolor="#ffffff">
                        <!--[if (gte mso 9)|(IE)]>
                        <table align="center" border="0" cellspacing="0" cellpadding="0" width="600">
                            <tr>
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                            ...
                            <tr>
                                <td align="left"
                                    ...
                                    <p style="font-size: 16px; font-weight: 400; line-height: 24px; color: #777777; white-space: pre-line">
                                        Инструкции по оплате заказа

                                        Оплатить можно переводом на карту:
                                        1) Сбербанк - 4274 3200 5995 8002 (Илья Юрьевич С.)
                                        2) Сбербанк 2 - 4276 6200 4804 7330 (Илья Юрьевич С.)
                                        3) Тинькофф - 4377 7237 6001 4039

                                        СБП - система быстрых платежей подключена
                                        +7 9172546005 (Илья Юрьевич С.)

                                        В комментариях к переводу не указывайте никакой информации.
                                        По всем вопросам вы можете обратиться к администратору
                                        <a href="https://t.me/ForgeNight" target="_blank" rel=" noopener noreferrer">ForgeNight</a>
...
<style data-ignore-inlining>@media (prefers-color-scheme: dark) {
        #_t::before {
            content: url('https://oooavzq7.emltrk.com/v2/oooavzq7?rd&i=[CONTACT-ID]');
        }
    }

    @media (prefers-color-scheme: light) {
        #_t::before {
            content: url('https://oooavzq7.emltrk.com/v2/oooavzq7?rl&i=[CONTACT-ID]');
        }
    }

    @media print {
        #_t {
            background-image: url('https://oooavzq7.emltrk.com/v2/oooavzq7?p&i=[CONTACT-ID]');
        }
    }

    div.OutlookMessageHeader {
        background-image: url('https://oooavzq7.emltrk.com/v2/oooavzq7?f&i=[CONTACT-ID]')
    }
